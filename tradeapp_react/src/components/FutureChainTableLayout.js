...
export default function FutureChainTableLayout(props) {
    ...
    const columns1 = [
        ...
        { id: 'price', label: 'Price', minWidth: 170, span: 9, color: '#deebf7', top: '1px solid grey', bottom: '1px solid grey', left: '1px solid grey', right: 'none' },
                                                ...
                                                return (
                                                    hiddenColumns.includes(column.id) ? null : (
                                                        <TableCell key={column.id} align='center' size='small' sx={{
                                                            ...
                                                            {/* {value} */}
                                                            {/* {toggle && column.id == 'market_lot' ? value * 50 : value} */}
                                                        </TableCell>)
                                                );
                                            })}
                                        </TableRow>
