...
export default function OptionIntradayTableStrikeLayout(props) {
    ...
    const header_columns = [
        ...
        { id: 'premium', label: 'Premium', minWidth: 100, span: 15, color: '#ffcc99', top: '1px solid grey', bottom: 'none', left: 'none', right: '1px solid grey' },
        { id: 'put_premium', label: 'Premium', minWidth: 100, span: 15, color: "#99ff99", top: '1px solid grey', bottom: 'none', left: 'none', right: '1px solid grey' },
