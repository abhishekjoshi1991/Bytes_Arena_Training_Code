"""DRF_CONCRETE_VIEWS URL Configuration
...
urlpatterns = [
    ...
    # instead of all these above urls, single url to get crud
    path('student_crud/', views.StudentCRUD.as_view()),
    path('student_crud/<int:pk>/', views.StudentCRUD.as_view()),
